...
built using an older, much more primitive version of the framework
used in Chapter \ref{adaptiveselection}, the source-code can be
...
argument.\footnote{Had I incorporated mortality or morbidity
...
This paper address two of the issues discussed in Chapter \ref{intro},
namely situations where the mixing assumption fails, and improving the
run-time efficiency of a model without sacrificing fidelity.  The
...
simple, but my fear was that addressing the central idea in a more
realistic way might obscure the basic simplicity of the idea, and
would need a significantly more capable modelling system for the
discourse.  At the time, the mathematical and programmatic resources I
could bring to bear on the matter were primitive.  A serendipitous
coincidence came about soon after this paper was submitted. I became
involved in what seemed to be unrelated work which sought to
incorporate social survey data into systems-management models. This
work lead to the development of a tree structure which could closely
follow the structural characteristics of the surveys, and provide a
robust mathematical means of allowing simulated individuals with
different attitudes, organisations or events to exert influence
(positively or negatively) the attitudes of others in the system.  The
mathematical work presented later arose from that project, and during
its development it became evident that this could provide a means of
