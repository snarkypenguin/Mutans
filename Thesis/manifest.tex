...
\newcommand{\NodeF}[2]{\left(\rv{#1},\rlabel{#2}\right)}
\newcommand{\NNodeF}[2]{\bigl(\rv{#1},\rlabel{#2}\bigr)}
\newcommand{\NNNodeF}[2]{\Bigl(\rv{#1},\rlabel{#2}\Bigr)}
\newcommand{\NNNNodeF}[2]{\BIGL(\rv{#1},\rlabel{#2}\BIGR)}
