...
%% \documentclass[a4]{frontiersSCNS}
...
%%  \newcommand{\extraAuth}[1]{}
%%  \newcommand{\topic}[1]{}

%% %
%% % search for keyFont, uncomment in the abstract
%% %
...
%% \DeclareMathOperator{\mie}{\ensuremath{\ i.e.\ }}
%% \DeclareMathOperator{\meg}{\ensuremath{\ e.g.\ }}
%% \DeclareMathOperator{\mst}{\ensuremath{\ s.t.\ }}
%% \DeclareMathOperator{\mand}{\ensuremath{\ and\ }}
%% \DeclareMathOperator{\mbut}{\ensuremath{\ but\ }}
%% \DeclareMathOperator{\mor}{\ensuremath{\ or\ }}
...
%% \UseSecondVersion{
%% \newcommand{\RING}[1]{\RNGI{\mb{T}}}
%% }{
%% \newcommand{\RING}[1]{\RNG{\mb{T}}}
%% }

%% \newcommand{\DOMQ}{\RING{\mb{T}}}
%% \newcommand{\DOMQs}[1]{\RING{{\mb{T}}_\mc{#1}}}

%% \newcommand{\TDOMQ}{\(\DOMQ\)}
%% \newcommand{\TDOMQs}[1]{\(\DOMQs{#1}\)}

%% \newcommand{\qnode}[1]{\RING{\mb{#1}}}
%% \newcommand{\qnulltree}{\qnode{\mathsf{O}}}
%% \newcommand{\qel}[2]{{\qnode{#1}}{{}_{_{#2}}}}
%% \newcommand{\qextn}[1]{\qel{#1}{\set{E}}}
%% \newcommand{\qlabel}[1]{\qel{#1}{\mc{S}}}
%% %%\newcommand{\qextn}[1]{\qel{#1}{\delta\set{E}}}
%% %%\newcommand{\qlabel}[1]{\qel{#1}{\delta\mc{S}}}
%% %%\newcommand{\qsubj}[1]{\qel{#1}{\delta}}
%% \newcommand{\qv}[1]{\qel{#1}{v}}
%% \newcommand{\qinertia}[1]{\qel{#1}{r}}
%% \newcommand{\qK}[1]{\qel{#1}{K}}
%% \newcommand{\qI}[1]{\qel{#1}{I}}
%% \newcommand{\qM}[1]{\qel{#1}{M}}

%% \newcommand{\tqnode}[1]{\(\RING{\node{#1}}\)}
%% \newcommand{\tqnulltree}{\(\qnode{\mathsf{O}}\)}
...
%% \newcommand{\extnOq}[5]{\bigl(\nrestrictedtoq{#1}{#2}\cup\nrestrictedtoq{#2}{#1}\cup\{\qnode{#3}{#5}\qnode{#4}:\qnode{#3}\in\restrictedtoq{#1}{#2}\mand\qnode{#4}\in\restrictedtoq{#2}{#1}\mand\qlabel{#3}=\qlabel{#4}\}\bigr)\setminus \{\nulltree\}}
%% \newcommand{\extnObq}[5]{\bigl(\nrestrictedtoq{#1}{#2}\cup\nrestrictedtoq{#2}{#1}  \\
%% & \qquad\cup\{\qnode{#3}{#5}\qnode{#4}:\qnode{#3}\in\restrictedtoq{#1}{#2}\mand\qnode{#4}\in\restrictedtoq{#2}{#1}\mand\qlabel{r}=\qlabel{s}\}\bigr)\setminus \{\nulltree\}}

%% %-- 

%% \newcommand{\DOMR}{\RING{\mb{T}}}
%% \newcommand{\DOMRs}[1]{\RING{{\mb{T}^\star}_\mc{#1}}}
...
%% \newcommand{\rnode}[1]{\RING{\mb{#1}}}
%% \newcommand{\rnulltree}{\rnode{\mathsf{O}}}
%% \newcommand{\rel}[2]{{\rnode{#1}}{{}_{_{#2}}}}
%% \newcommand{\rv}[1]{\rel{#1}{v}}
%% \newcommand{\rextn}[1]{\rel{#1}{\set{E}}}
%% \newcommand{\rlabel}[1]{\rel{#1}{\mc{S}}}
%% %%\newcommand{\rextn}[1]{\rel{#1}{\delta\set{E}}}
%% %%\newcommand{\rlabel}[1]{\rel{#1}{\delta\mc{S}}}
...
%% \newcommand{\extnOr}[5]{\bigl(\nrestrictedtor{#1}{#2}\cup\nrestrictedtor{#2}{#1}\cup\{\rnode{#3}{#5}\rnode{#4}:\rnode{#3}\in\restrictedtor{#1}{#2}\mand\rnode{#4}\in\restrictedtor{#2}{#1}\mand\qlabel{#3}=\qlabel{#4}\}\bigr)\setminus \{\nulltree\}}
%% \newcommand{\extnObr}[5]{\bigl(\nrestrictedtor{#1}{#2}\cup\nrestrictedtor{#2}{#1} \\
%% & \qquad\cup\{\rnode{#3}{#5}\rnode{#4}:\rnode{#3}\in\restrictedtor{#1}{#2}\mand\rnode{#4}\in\restrictedtor{#2}{#1}\mand\qlabel{r}=\qlabel{s}\}\bigr)\setminus \{\nulltree\}}
...
%% \newcommand{\capplus}{\mbox{\ooalign{{\large\(\cap\)}\cr\hidewidth\({+}\)\hidewidth\cr}}}
%% \newcommand{\cupplus}{\mbox{\ooalign{{\large\(\cup\)}\cr\hidewidth\({+}\)\hidewidth\cr}}}
...
%% \newcommand{\lbl}[1]{\mc{#1}}
%% \newcommand{\Tlbl}[1]{$\mc{#1}$}
...
%%   \fontencoding{T1}%
%%   \selectfont}
%% \newcommand\textpzc[1]{\begingroup
%%   \fontfamily{pzc}%
%%   \fontencoding{T1}%
%%   \selectfont #1\endgroup}

%% \def\calli#1{{\calligra #1}}
%% \def\chanc#1{{\chancery #1}}
...
%% %\newcommand{\stree}[3]{\ensuremath{(\!:\mc{#1}, #2, \{#3\}:\!)}}
%% %\newcommand{\stree}[3]{\ensuremath{(\!\vert\mc{#1}, #2, \{#3\}\vert\!)}}
%% %\newcommand{\stree}[3]{\ensuremath{(\!\vert\mc{#1}, #2, \{#3\}\vert\!)}}
%% %\newcommand{\etree}[3]{\ensuremath{(\mc{#1}, #2, \{#3\})}}
...
%% % theorem stuff
%% \newtheorem{theorem1}{Global theorem}
...
%% \def\journal{Environmental Science}%%% write here for which journal %%%
%% \def\DOI{}
%% \def\articleType{Methods Article}
%% \def\keyFont{\fontsize{8}{11}\helveticabold }
%% \def\firstAuthorLast{Gray {et~al}} %use et al only if is more than 1 author
%% \def\Authors{Randall Gray\,$^{1,*}$ and Simon Wotherspoon\,$^{2}$}

%% % Affiliations should be keyed to the author's name with superscript numbers and be listed as follows: Laboratory, Institute, Department, Organization, City, State abbreviation (USA, Canada, Australia), and Country (without detailed address information such as city zip codes or street names).
%% % If one of the authors has a change of address, list the new address below the correspondence details using a superscript symbol and use the same symbol to indicate the author in the author list.
%% \def\Address{$^{1}$Mathematics, University
...
%% \def\corrAuthor{Randall Gray}
%% \def\corrAddress{Mathematics, University of Tasmania, Sandy Bay,
%%   Tasmania}
...
%% \def\corrEmail{Randall.Gray@limnal.net}

%% %- Beginning of document bits
...
%% %-- Title
%% \title[Adaptive hybrid models]{Adaptive submodel selection in hybrid models}
%% \author[\firstAuthorLast ]{\Authors}
%% \address{}
%% \correspondance{}
%% \extraAuth{}% If there are more than 1 corresponding author, comment this line and uncomment the next one.
%% %\extraAuth{corresponding Author2 \\ Laboratory X2, Institute X2, Department X2, Organization X2, Street X2, City X2 , State XX2 (only USA, Canada and Australia), Zip Code2, X2 Country X2, email2@uni2.edu}
%% \topic{Hybrid Solutions for the Modeling of Complex Environmental Systems}% If your article is part of a Research Topic, please indicate here which.
...
%%   discussed.  \tiny\keyFont{\section{Keywords: Hybrid model
%%       Adaptive-rep\-re\-sen\-ta\-tion En\-vi\-ron\-men\-tal-modeling
%%       Cross-paradigm-modeling}}
%% \end{abstract}
