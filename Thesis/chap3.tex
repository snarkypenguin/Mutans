...
\begin{center}
  ...
  \caption{Time scheduling strategies.  Red boxes represent time steps that
    ...
    have adaptive time steps.}\label{times}
\end{center}
\end{figure}
...
%---- Algorithm MonAlg
\begin{algorithm}
  \caption{Basic processing pass for the monitor}\label{MonAlg}
  \begin{algorithmic}
    \ForAll{niches}
...
\begin{center}
  ...
  \caption{The model domain is divided into nine cells. An \SD\ agent
    ...
    will be associated with one cell at any given time.}\label{domain}
\end{center}
\end{figure}
...
%------ fruitalg
\begin{algorithm}
  \caption{Basic processing pass for fruit}\label{fruitalg}
  \begin{algorithmic}
...
%------ seedalg
\begin{algorithm}
  \caption{Basic processing pass for seeds}\label{seedalg}
  \begin{algorithmic}
...
\begin{algorithm}
  ...
  \caption{Basic processing pass for the \SD\ models}\label{sdalg}
\begin{algorithmic}
...
%------ plantalg
\begin{algorithm}
  \caption{Basic processing pass for plants}\label{plantalg}
  \begin{algorithmic}
...
%------ animalalg
\begin{algorithm}
  \caption{Basic processing pass for herbivores and carnivores}\label{animalalg}
  \begin{algorithmic}
...
\begin{center}
  ...
  \caption{The color of the \textbsf{p},\textbsf{h} and \textbsf{c}
    ...
    relevant biomass.}\label{timeline}
\end{center}
\end{figure}
...
\begin{center}
  ...
  \caption{Normalized indexes of execution speed (black) and fidelity (red) the 
    against configuration changes through time associated with Figure~\ref{timeline}}\label{indices}
\end{center}
\end{figure}
