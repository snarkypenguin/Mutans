...
\begin{table}[H]
\begin{center}
  \caption{Fundamental classes in the model -- \fname{framework-classes.scm}\label{classtableI}}
...
\begin{table}[H]
\begin{center}
  \caption{Introspection classes in the model -- \fname{introspection-classes.scm}\label{classtableII}}
  \begin{tabular}{l L{7cm}}
    \toprule
    \textbf{Classname} & \textbf{role} \\
    \midrule
...
\begin{center}
  ...
  classes used to represent the animals in the example model are
...
%% trees described briefly in Chapter \refthree and more
