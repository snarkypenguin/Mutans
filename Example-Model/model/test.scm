...
;; 								 (lambda (call-next-method object initargs) (call-next-method) (display " (initialize <object> ")(display initargs)(newline) object)))

;; (add-method initialize
;; 				(make-method (list <metal>)
;; 								 (lambda (call-next-method object initargs)
;; 									(display " [initialize <metal>] ")
;; 									(display initargs)
;; 									(display "\n--> ")
;; 									(call-next-method)
;; 									(newline)
