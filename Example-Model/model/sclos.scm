...
; in AMOP.  This implementation is not at all optimised, but the MOP is
; designed so that it can be optimised.  In fact, this MOP allows better
; optimisation of slot access extenstions than those in AMOP.
; 
;
;
