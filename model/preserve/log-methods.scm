...
(model-method (<log-map> <introspection> <introspection> <symbol> <list>)
...
(model-method (<log-data> <introspection> <symbol>) (page-preamble self logger format)
...
;; here as an example.
(model-method (<log-data> <introspection> <symbol> <procedure>)
