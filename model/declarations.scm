...
(declare-method age "return the age of the <living-thing>")
...
(declare-method radius "returns the radius of the plant, landscape for or other such thing") 
...
(declare-method run-model-body "This makes the generic version of the model-bodies.")
